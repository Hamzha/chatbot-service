(function () {
  ...
  welcome.textContent = "Hey, welcome. This is a polished UI demo widget. Connect API next for real answers.";
  body.appendChild(welcome);

  var typing = document.createElement("div");
  typing.className = "cb-widget-typing";
  typing.innerHTML = '<span class="cb-widget-dot"></span><span class="cb-widget-dot"></span><span class="cb-widget-dot"></span>';
  ...
  form.addEventListener("submit", function (event) {
    ...
    window.setTimeout(function () {
      ...
      botMsg.textContent = "Demo mode reply. Your UI is ready. Next step is API wiring.";
